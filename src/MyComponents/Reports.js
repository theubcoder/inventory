            ...
            <div className={`flex flex-col sm:flex-row sm:items-center gap-3 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
              ...
              <div className={`flex flex-col sm:flex-row gap-3 flex-1 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
                ...
                <div className={`flex flex-col sm:flex-row sm:items-center gap-2 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
                  <label className="text-sm font-medium text-gray-700 whitespace-nowrap">{t('from')}:</label>
                  <input
                    type="date"
                ...
                {/* To Date */}
                <div className={`flex flex-col sm:flex-row sm:items-center gap-2 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
                  <label className="text-sm font-medium text-gray-700 whitespace-nowrap">{t('to')}:</label>
                  <input
                    type="date"
              ...
              {/* Buttons Container */}
              <div className={`flex gap-2 mt-3 sm:mt-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
                <button
